        ...
        <div class="row">
            ...
            <div class="col-md-3 sidebar ">
                ...
                <ul>
                    ...
                    <li><a href="add_products.php"   class="act "> <i class="fa fa-cart-arrow-down  fa-2x" aria-hidden="true"></i> <span>Add product</span></a></li>
                    <li><a href="password.php"> <i class="fa fa-unlock-alt fa-2x" aria-hidden="true"></i></i> <span>Change Password</span></a></li>
                    <li><a href="my_products.php"> <i class="fa fa-cube fa-2x" aria-hidden="true"></i> <span>My products</span></a></li>
