                                  ...
                                  <?php if (isset(Yii::app()->session['post']['masters']) && Yii::app()->session['post']['masters'] == 1) { ?>
                                                        <li class="<?php echo $actionn4 ?> treeview">
                                                                ...
                                                                <ul class="treeview-menu">
                                                                        ...
                                                                        <li class="<?php echo $action9 ?> treeview"><a href="<?php echo Yii::app()->baseUrl ?>/admin.php/masters/shippingCharges/admin"><i class="fa fa-circle-o"></i>Shipping Rates</a></li>
